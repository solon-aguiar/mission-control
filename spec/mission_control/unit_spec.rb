RSpec.describe Unit do
  ...
  describe 'se_to_ms' do
    it 'converts properly' do
      ...
      expect(Unit::se_to_ms(1000)).to eq(1000_000.0)
    end
  end
  ...
  describe 'km_per_hour_to_km_per_se' do
    it 'converts within an error range' do
      ...
      expect(Unit::km_per_hour_to_km_per_se(1000)).to be_within(0.0001).of(0.27777)
      expect(Unit::km_per_hour_to_km_per_se(1500)).to be_within(0.0001).of(0.41666)
      expect(Unit::km_per_hour_to_km_per_se(15000)).to be_within(0.0001).of(4.1666)
    end
  end
  ...
  describe 'liters_per_minute_to_liters_per_sec' do
    it 'converts within an error range' do
      ...
      expect(Unit::liters_per_minute_to_liters_per_sec(1000)).to be_within(0.0001).of(16.66666)
      expect(Unit::liters_per_minute_to_liters_per_sec(1500)).to be_within(0.0001).of(25.0)
      expect(Unit::liters_per_minute_to_liters_per_sec(15000)).to be_within(0.0001).of(250.0)
    end
  end
end